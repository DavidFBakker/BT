...
namespace EMDB
{
    ...
    public static class DB
    {
        ...
        public static DateTime StartDate(EMContext dbContext=null)
        {
            if (dbContext == null)
        ...
        public static DateTime EndDate(EMContext dbContext = null)
        {
            if (dbContext == null)
                dbContext = GetContext();
        ...
        public static IEnumerable<Plot> GetPacketsQ(EMContext dbContext, string node, Constants.InputType inputEnum, DateTime startDate, DateTime endDate)
        {
